        ...
        internal void RunInstruction(Instruction i) {
            switch (i.operation) {
                ...
                case ByteCode.RunLine:
                    ...
                    var stringOperand = (string)i.operandA;
                    var lineText = program.GetString(stringOperand);
                    ...
                    lineHandler(new Dialogue.LineResult(lineText, stringOperand));
